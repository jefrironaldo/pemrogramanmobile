...
private ArrayList<DataMhs> dataMhsArrayList;
    ...
    private void addData(){
        ...
        dataMhsArrayList.add(new DataMhs("72160086-jefri ronaldo asadama", "kota baru", "HaroldMaga@gmail.com", "jefri ronaldo asadama"));
        dataMhsArrayList.add(new DataMhs("72160025-sombuk", "Seturan", "sombuk@gamil.com", "sombuk"));
    }
}
